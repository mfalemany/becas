<?php
class ci_carga_individual extends becas_ci
{
	protected $s__datos;

	function conf(){
		$this->s__datos = array('nro_documento'=>'32405039','nro_documento_dir'=>'32405039');
	}
	//-----------------------------------------------------------------------------------
	//---- form_beca_externa ------------------------------------------------------------
	//-----------------------------------------------------------------------------------

	function conf__form_beca_externa(becas_ei_formulario $form)
	{
