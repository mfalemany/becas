<?php
class ci_informes_plazos extends becas_ci
{
	...
	function conf__cu_plazos(becas_ei_cuadro $cuadro)
	{
		$cuadro->set_datos(toba::consulta_php('co_informes')->get_plazos());
	}
	...
	function conf__form_plazos(becas_ei_formulario $form)
	{
