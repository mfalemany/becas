...
--
-- Name: antec_particip_cursos; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE antec_particip_cursos (
...
ALTER TABLE antec_particip_cursos OWNER TO postgres;
...
ALTER SEQUENCE antec_particip_cursos_id_particip_cursos_seq OWNED BY antec_particip_cursos.id_particip_cursos;
...
ALTER TABLE ONLY antec_particip_cursos ALTER COLUMN id_particip_cursos SET DEFAULT nextval('antec_particip_cursos_id_particip_cursos_seq'::regclass);
...
SELECT pg_catalog.setval('antec_activ_docentes_id_antecedente_seq', 1, false);
...
COPY antec_becas_obtenidas (id_beca_obtenida, institucion, tipo_beca, id_tipo_doc, nro_documento) FROM stdin;
\.
...
SELECT pg_catalog.setval('antec_becas_obtenidas_id_beca_obtenida_seq', 1, false);
...
COPY antec_estudios_afines (id_estudio_afin, nombre, institucion, anio_desde, anio_hasta, titulo, id_tipo_doc, nro_documento) FROM stdin;
\.
...
SELECT pg_catalog.setval('antec_estudios_afines_id_estudio_afin_seq', 1, false);
...
--
-- Data for Name: antec_particip_cursos; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY antec_particip_cursos (id_particip_cursos, institucion, carga_horaria, fecha, id_tipo_doc, nro_documento) FROM stdin;
\.
...
SELECT pg_catalog.setval('antec_trabajos_publicados_id_trabajo_publicado_seq', 1, false);
...
2017-11-01	2017-11-30	2017-11-30	5	BECAS INTERNAS SGCYT UNNE	5
\.
...
SELECT pg_catalog.setval('requisitos_convocatoria_id_requisito_seq', 15, true);
...
SELECT pg_catalog.setval('tipos_beca_id_tipo_beca_seq', 7, true);
...
SELECT pg_catalog.setval('tipos_convocatoria_id_tipo_convocatoria_seq', 5, true);
...
ALTER TABLE ONLY antec_particip_cursos
